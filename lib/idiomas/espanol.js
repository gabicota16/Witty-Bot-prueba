...
const smsLista7 = () => { return `🐈 INSTALAR WITTYBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝕊𝕦𝕡𝕖𝕣 𝕎𝕚𝕥𝕥𝕪-𝔹𝕠𝕥 - 𝕎𝕙𝕒𝕥𝕤𝕒𝕡𝕡 '} 
...
const eGataCoins = () => { return '🪙 WittyCoins' }
const eGataTickers = () => { return '🎫 Witty Tickers' } 
const eEnergia = () => { return '✨ Energía' }
const ePocion = () => { return '🥤 Posión' }
...
const smsContacto4 = () => { return 'Contacto Oficial de WittyBot'}
